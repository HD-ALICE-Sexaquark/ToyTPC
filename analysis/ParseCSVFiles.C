...
void ParseCSVFiles(TString simdir, Int_t job_n = 0, Int_t run_n = 0) {
    ...
    */
    ...
    // needed for DCA calc.
    Double_t pv[3] = {0., 0., 0.};
    Double_t helix_params[5];
    Double_t tmp_dca_wrt_pv;
        ...
        for (Particle_tt &part : evt.particles) {
            ...
            if (n_tpc_hits >= 100) {
                ...
                if (helixfit_state) {
                    helix_params[0] = x_c;
                    helix_params[1] = y_c;
                    helix_params[2] = radius;
                    helix_params[3] = helix_omega;
                    helix_params[4] = helix_phi;
                    tmp_dca_wrt_pv = CalculatePointToHelixDCA(pv, helix_params);
                }
                ...
                */
                ...
                if (circlefit_state && helixfit_state) {
                    ...
                    part.dca_wrt_pv = tmp_dca_wrt_pv;
                }
