...
// ********************************************************************
//
/// \file G4Setup/src/TimeProjectionChamberSD.cc
/// \brief Implementation of the B2a::TimeProjectionChamber class
...
void TimeProjectionChamberSD::Initialize(G4HCofThisEvent* hce) {
    fHitsCollection = new TimeProjectionChamberHitsCollection(SensitiveDetectorName, collectionName[0]);
...
G4bool TimeProjectionChamberSD::ProcessHits(G4Step* step, G4TouchableHistory*) {
